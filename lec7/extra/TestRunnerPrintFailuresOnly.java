...
public class TestRunnerPrintFailuresOnly extends RunListenerWithCapture {
    
    private boolean mostRecentTestPassed;
    private String mostRecentTestName;

    /* Code to run at the beginning of a test run. */
    public void testRunStarted(Description description) throws Exception {
        System.out.println("Running JUnit tests using jh61b.junit.TestRunner in \"failure\" mode.\n");
    }
    ...
    public void testStarted(Description description) throws Exception { 
        mostRecentTestName = String.format("%s", description.getMethodName());
    ...
    public void testFailure(Failure failure) throws Exception {
        //System.out.print("Failure while running " + mostRecentTestName + ": ");
        String printedOutput = this.endCapture();                
    ...
    public static void runTests(Class<?>... classes) {
        ...
        runner.addListener(new TestRunnerPrintFailuresOnly());
        runner.run(classes);
    }
}